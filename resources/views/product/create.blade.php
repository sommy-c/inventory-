...
<div class="form-container">
    ...
    <form id="add-product-form" action="{{ route('admin.products.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="barcode" id="barcode" value="{{ old('barcode') }}" autofocus>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="supply_date" id="supply_date" value="{{ old('supply_date') }}">
            </div>
            ...
            <div class="form-group full-width">
                <label>
                    <input type="checkbox" name="is_suspended" value="1" {{ old('is_suspended') ? 'checked' : '' }}>
                    Suspend Product
                </label>
            </div>
        </div>
